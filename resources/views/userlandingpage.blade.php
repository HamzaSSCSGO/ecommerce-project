        ...
        <div class="row">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="{{route('userlandingpage')}}">Home</a></li>
        ...
        <div class="col-md-12">
            <div class="brand-wrapper">
                <div class="brand-list">
                    <img src="{{URL('img/brand1.png')}}" alt="">
                    <img src="{{URL('img/brand2.png')}}" alt="">
                    <img src="{{URL('img/brand3.png')}}" alt="">
                    <img src="{{URL('img/brand4.png')}}" alt="">
                    <img src="{{URL('img/brand5.png')}}" alt="">
                    <img src="{{URL('img/brand6.png')}}" alt="">
                    <img src="{{URL('img/brand1.png')}}" alt="">
                    <img src="{{URL('img/brand2.png')}}" alt="">                            
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="single-product-widget">
                ...
                <div class="single-wid-product">
                    <a href="single-product.html"><img src="{{URL('img/product-thumb-1.jpg')}}" alt="" class="product-thumb"></a>
                ...
                <div class="single-wid-product">
                    <a href="single-product.html"><img src="{{URL('img/product-thumb-2.jpg')}}" alt="" class="product-thumb"></a>
                ...
                <div class="single-wid-product">
                    <a href="single-product.html"><img src="{{URL('img/product-thumb-3.jpg')}}" alt="" class="product-thumb"></a>
        ...
        <div class="col-md-4">
            <div class="single-product-widget">
                ...
                <a href="#" class="wid-view-more">View All</a>
                <div class="single-wid-product">
                    <a href="single-product.html"><img src="{{URL('img/product-thumb-4.jpg')}}" alt="" class="product-thumb"></a>
